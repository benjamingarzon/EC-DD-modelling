...
reg_labels = c(
  "Intercept" =  "Intercept",                                                    
  "GroupLowvol.first"= "Group (low variance first)",
  "ContextLowvariance"= "Context (low variance)",                            
  ...
  "GroupLowvol.first:ContextLowvariance" = "Group (low variance first) x context (low variance)",
  "ContextLowvariance" = "Context (low variance)",
  "GroupLowvol.first:amount_later_centered" = "Group (low variance first) x later reward (centered)",
  "ContextLowvariance:amount_later_centered" = "Context (low variance) x later reward (centered)",
  "GroupLowvol.first:ContextLowvariance:amount_later_centered" = "Group (low variance first) x later reward (centered)",
