...
reg_labels = c(
  "(Intercept)" =  "Intercept",                                                    
  "GroupLow vol. first"= "Group (low volatility first)",                                "ContextLow volatility"= "Group (low volatility first)",                            
  ...
  "GroupLow vol. first:ContextLow volatility" = "Group (low volatility first) x context (low volatility)",                      
  ...
  "Context (low volatility) x later reward (centered)",
...
choice.fixef = cbind(Parameter = unlist(reg_labels[rownames(choice.fixef)]), choice.fixef)
...
c(
 ...
 "df",
 "p-value")
rt.fixef = cbind(Parameter = unlist(reg_labels[rownames(rt.fixef)]), rt.fixef)
rt.cor.fixef = cbind(Parameter = unlist(reg_labels[rownames(rt.cor.fixef)]), rt.cor.fixef)

statslist['_table_choice.fixef_'] = tab_to_str(choice.fixef[c(1,2,4,5)])
statslist['_table_rt.fixef_'] = tab_to_str(rt.fixef[c(1,2,4,5)])
statslist['_table_rt.cor.fixef_'] = tab_to_str(rt.cor.fixef[c(1,2,4,5)])
```
