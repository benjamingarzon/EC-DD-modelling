...
MYFILE = '../results/linear_drift_variability_no_pooling_bd_ddm-28-10-2023_20:24-10000-1e+05-jags-pars.RData'
load(MYFILE)
numSubjs = dataList$N
...
numPars <- 6
parVals$noise.p = parVals$boundary.p
...
get_par_jags("sigma.p", var2 = "Context", var = "context_order")
