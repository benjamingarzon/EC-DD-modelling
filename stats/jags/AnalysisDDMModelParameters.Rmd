...
unixtools::set.tempdir("~/ddm/EC-DD-modelling/stats/tmp1")
...
mypars.rating = c("bid.diff", "log_key.rt") # , "bid.rt.max")
...
ss.2 <- fe_summary[sprintf("%s:amount_later_centered", mypar), ] #c("Estimate", "Est.Error", "Q2.5", "Q97.5")]
...
fig.e = ggarrange(plotlist = myplots.list[c(7, 10)],
                  ncol = 1,
                  nrow = 2)

ggsave(
  filename = file.path(FIGS_DIR, "SigAssociations.png"),
  plot = fig.e,
  dpi = DPI,
  width = WIDTH1COL * 2,
  height = HEIGHT1ROW * 2
