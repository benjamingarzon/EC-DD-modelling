...
init100 = F #params$init100 == 'true'
if (init100) {
  MYFILE = '../results/linear_drift_no_pooling_ddm-processed_data_balanced_censored_100-08-08-2025_07:15-20000-50000-jags-pars.RData'
load(MYFILE)
load(file.path(WDD, "processed_data_balanced_censored_100.RData"))
IMAGE_FILE = file.path("../results/AnalysisDDMModelParameters_workspace_100")
...
pars <- c(mypar, sprintf("%s:amount_later", mypar))
...
ss.1 <- fe_summary[mypar, ] #c("Estimate", "Est.Error", "Q2.5", "Q97.5")]
