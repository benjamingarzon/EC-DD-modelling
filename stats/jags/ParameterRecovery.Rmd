...
SIMPARSFILE = '../results/linear_drift_no_pooling_ddm-processed_data_balanced_censored-simulated-10-09-2025_06:29-20000-50000-jags-pars.RData'
...
while (i <= sim_subjs){
  print(i)
  for (cont in c('High variance', 'Low variance')){
