...
Rscript FitDDMtoTaskData.R processed_data_balanced_censored-simulated.RData linear_drift_no_pooling_bd_ddm $NSAMPLES $NBURNIN > ../logs/log-linear_drift_no_pooling_simulated_bd_ddm-${NSAMPLES}-${NBURNIN}.txt &
