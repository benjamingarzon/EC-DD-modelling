...
Rscript FitDDMtoTaskData.R processed_data_censored.RData linear_drift_no_pooling_bd_ddm $NSAMPLES $NBURNIN > ../logs/log-linear_drift_variability_no_pooling_bd_ddm-${NSAMPLES}-${NBURNIN}.txt &
#NBURNIN=10000
#Rscript FitDDMtoTaskData.R processed_data_censored.RData linear_drift_variability_no_pooling_ddm $NSAMPLES $NBURNIN > ../logs/log-linear_drift_variability_no_pooling_ddm-${NSAMPLES}-${NBURNIN}.txt
